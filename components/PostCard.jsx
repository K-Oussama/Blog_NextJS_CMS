    ...
    <div className='bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8'>
      ...
      <h1 className='transaition duration-700 text-center mb-8 cursor:pointer hover:text-pink-600 text-3xl font-semibold'>
        ...
        <div className="text-center">
          <Link href={`/post/${post.slug}`}>
            <span className='transition duration-500 transform hover:-translate-y-1 inline-block bg-pink-600 text-lg font-medium rounded-full text-white px-8 py-3 cursor-pointer'>View More</span>
        </Link></div>
    </div>
  )
}
